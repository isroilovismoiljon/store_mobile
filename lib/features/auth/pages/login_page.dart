            ...
            builder: (context, state) {
              return Column(
                ...
                children: [
                  ...
                  CustomButton(
                    title: 'Login',
                    buttonColor: isValidEmail && isValidPassword ? Colors.black : Theme.of(context).colorScheme.secondary,
                    onPressed: () {
                      isValidEmail && isValidPassword
                          ? {
                              context.read<LoginBloc>().add(
                                LoginRequestEvent(
                                  model: LoginModel(login: emailController.text, password: passwordController.text),
                                ),
                              ),
                              if (state.statusLogin == Status.success) {context.go(Routes.home)},
                            }
                          : null;
                    },
                  ),
